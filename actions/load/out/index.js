...
async function run() {
    _actions_core__WEBPACK_IMPORTED_MODULE_2__.info("actions/load");
    ...
    files.forEach((file) => {
        ...
        const contents = fs__WEBPACK_IMPORTED_MODULE_0__.readFileSync(file.path, "utf8");
        _actions_core__WEBPACK_IMPORTED_MODULE_2__.info(contents);
